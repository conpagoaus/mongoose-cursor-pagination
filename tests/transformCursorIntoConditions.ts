import { transformCursorIntoConditions } from '../lib/utils';
...
describe('utils#transformCursorIntoConditions', () => {
  it('Works with 1 key', () => {
    ...
    expect(conditions).toEqual([{ _id: { $lt: '5b06b90b42a0b29ba10f20c2' } }]);
  });
  ...
  it('Cursor keys must be a subset of sort keys', () => {
    ...
    expect(() => transformCursorIntoConditions({ cursorObj, sortObj })).toThrow(
